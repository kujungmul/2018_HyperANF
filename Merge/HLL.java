...
/**
* Author: Sabina Hult
* Implementation of HyperLogLog with merge-function from pseudo-code
*/
...
public class HLL {
    ...
    public void add(int x) {
        ...
        int val = Integer.numberOfLeadingZeros(h(x)) + 1;
        if(M[j] < val) M[j] = val;
    }
    ...
    // merge another HLL counter into this one
    ...
    // calculation of the estimated distinct elements
    ...
    // hash to one of m buckets
    private int f(int y) {
        return ((y * 0xbc164501) & 0x7fe00000) >> 21;
    }

    // ensure uniformly distributed numbers
